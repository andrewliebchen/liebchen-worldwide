  ...
  return (
    <ThemeUIProvider theme={theme}>
      ...
      <Box sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Flex p={6} sx={{ gap: 4, flexDirection: "column", bg: "#FFF" }}>
          <Text>
            With over a decade of experience in crafting consumer, enterprise,
            and data-driven product experiences, from pre-money start-ups to
            giants like Meta, I bring the insight and expertise of a full-time
            product designer to your project - on a contractor basis.
          </Text>
          <Grid columns="1fr 1fr">
            ...
            <Text sx={{ fontSize: 4 }}>
              ...
              approach, I accept equity in lieu of full-time salary. This
              ensures our goals are aligned, and I am as invested in your
              success as you are.
            </Text>
          </Grid>
          <Grid columns="1fr 1fr">
            ...
            <Box>
              <Box pb={4}>
                ...
                <Text sx={{ fontSize: 4 }}>
                  ...
                  Simplifying the complex and addressing the core issues faced
                  by users.
                </Text>
              </Box>
            ...
            <Box>
              <Box pb={4}>
                ...
                <Text sx={{ fontSize: 4 }}>
                  ...
                  establishing the app's design and brand from scratch,
                  embodying the spirit of unity and volunteerism.
                </Text>
              </Box>
